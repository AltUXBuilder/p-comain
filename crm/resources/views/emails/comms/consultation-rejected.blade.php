...
<p>Hi {{ $patient?->first_name }}, thank you for completing your consultation with Prescribe &amp; Co.</p>
<p>After careful clinical review, our prescriber was unable to approve a prescription at this time.</p>
@if($rejection?->patient_notified && $rejection?->reason)
<p>For your information, the reason given was: <em>{{ $rejection->reason }}</em></p>
@endif
<p>If you have questions about this decision, please contact our clinical team who will be happy to advise.</p>
<a href="{{ config('app.url') }}/contact" class="btn">Contact us →</a>
<p style="font-size:12px;color:#9b88a8">Email: <a href="mailto:pharmacy@prescribeandco.co.uk" style="color:#8e61a3">pharmacy@prescribeandco.co.uk</a></p>
</div>
